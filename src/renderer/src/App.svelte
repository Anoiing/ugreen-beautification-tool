...
<div class="container">
  ...
  <div class="text-red-500 links">
    <div class="link-item">
      <a
        rel="noopener noreferrer"
        target="_blank"
        href="https://evite.netlify.app">Documentation</a
      >
    </div>
    ...
    <div class="link-item">
      <a
        rel="noopener noreferrer"
        target="_blank"
        href="https://github.com/alex8088/electron-vite">Getting Help</a
      >
    </div>
    <div class="link-item link-dot">•</div>
    <div class="link-item">
      ...
      <article>
        ...
        <p class="detail">
          ...
          <a
            rel="noopener noreferrer"
            target="_blank"
            href="https://evite.netlify.app/config/">config guide</a
          >.
        </p>
      </article>
    </div>
      ...
      <article>
        ...
        <p class="detail">
          ...
          <a
            rel="noopener noreferrer"
            target="_blank"
            href="https://evite.netlify.app/guide/hmr.html">docs</a
          >.
        </p>
      </article>
    </div>
